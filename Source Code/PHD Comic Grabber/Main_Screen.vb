...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'button_download
        '
        Me.button_download.BackColor = System.Drawing.Color.Silver
        ...
        'button_folderbrowse
        '
        Me.button_folderbrowse.BackColor = System.Drawing.Color.Silver
        ...
        'Button_ListFiles
        '
        Me.Button_ListFiles.BackColor = System.Drawing.Color.Silver
        ...
        Me.txtAccept.Size = New System.Drawing.Size(192, 41)
        ...
        'txtselectedfile
        '
        Me.txtselectedfile.BackColor = System.Drawing.Color.White
        ...
        Me.ToolTip1.SetToolTip(Me.Label7, "The file extensions accepted by the Parser")
        '
        'Label8
        '
        ...
        Me.Label8.Location = New System.Drawing.Point(424, 144)
        Me.Label8.Name = "Label8"
        Me.Label8.Size = New System.Drawing.Size(184, 16)
        Me.Label8.TabIndex = 31
        Me.ToolTip1.SetToolTip(Me.Label8, "The file extensions accepted by the Parser")
        '
        'Label9
        '
        ...
        Me.Label9.ForeColor = System.Drawing.Color.FromArgb(CType(255, Byte), CType(128, Byte), CType(0, Byte))
        Me.Label9.Location = New System.Drawing.Point(424, 160)
        Me.Label9.Name = "Label9"
        Me.Label9.Size = New System.Drawing.Size(184, 16)
        Me.Label9.TabIndex = 32
        Me.Label9.Text = "3600"
        Me.ToolTip1.SetToolTip(Me.Label9, "The file extensions accepted by the Parser")
        '
        'txtParse
        '
        ...
        'txtLastDownload
        '
        Me.txtLastDownload.BackColor = System.Drawing.Color.White
        ...
        Me.NotifyIcon1.Text = "PHD Comic Grabber"
        '
        'ContextMenu1
        '
        ...
        Me.MenuItem3.Text = "Show PHD Comic Grabber"
        '
        'MenuItem5
        '
        ...
        Me.Text = "PHD Comic Grabber (Build 20050712.2)"
...
#End Region
    ...
    Private Sub Error_Handler(ByVal message As String, Optional ByVal dialog As Boolean = False)
        Try
            ...
            Dim disp As Display_Message = New Display_Message("PHD Comic Grabber Recorded the following error at " & Now() & ":" & vbCrLf & message)
        ...
        Catch ex As Exception
            MsgBox("An error occurred in PHD Comic Grabber's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub

    Private Sub listfile_button_work()
        Try
            workerpaused = False
            Label5.Hide()
            disable_controls()
    ...
    Public Sub Load_Registry_Values()
        Try
            ...
            For Each str In keys
                If str.Equals("Software\PHD Comic Grabber") = True Then
                    keyflag1 = True
                    Exit For
                End If
            Next str
            ...
            If keyflag1 = False Then
                oReg.CreateSubKey("Software\PHD Comic Grabber")
            End If

            keyflag1 = False

            Dim oKey As RegistryKey = oReg.OpenSubKey("Software\PHD Comic Grabber", True)
            ...
            Else
                configflag = True
                oKey.SetValue("savepath", "d:\wwwroot\newsfeed\images\phd\")
                txtSavePath.Text = "d:\wwwroot\newsfeed\images\phd\"
            End If
            ...
            Else
                configflag = True
                oKey.SetValue("URL", "http://www.phdcomics.com/comics/archive.php?comicid=100000")
                txtURL.Text = "http://www.phdcomics.com/comics/archive.php?comicid=100000"
            End If
            ...
            Else
                configflag = True
                oKey.SetValue("acceptfile", "gif")
                txtAccept.Items.Clear()
                txtAccept.Items.Add("gif")
            End If
    ...
    Private Sub download_button_work()
        Try
            workerpaused = False
            Label5.Hide()
            downloadstatus = True
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        Try
            Label9.Text = CLng(Label9.Text) - 1
            Label9.Refresh()
            Label8.Text = Format(Now(), "dd/MM/yyyy hh:mm:ss tt")
            Label8.Refresh()
            If CLng(Label9.Text) = 0 Then
                Label9.Text = 3600
                listfile_button_work()
            End If
        Catch ex As Exception
